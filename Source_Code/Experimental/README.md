...
- **`TNF-MI-WD-estimation-Exp-Data-4hr.py`** – Computes MI and 2-WD for the 4-hour TNF response.
- **`TNF-MI-WD-estimation-Exp-Data-30min.py`** – Computes MI and 2-WD for the 30-minute TNF response.
...
- **`TNF-MI-WD-convergence-4hr.py`** – Performs convergence analysis for the 4-hour TNF response.
- **`TNF-MI-WD-convergence-30min.py`** – Performs convergence analysis for the 30-minute TNF response.
...
- **`TNF-mapping-factor-estimation-4hr.py`** – Estimates mapping factors for the 4-hour TNF response.
- **`TNF-mapping-factor-estimation-30min.py`** – Estimates mapping factors for the 30-minute TNF response.
...
```bash
python TNF-MI-WD-estimation-Exp-Data-4hr.py
python TNF-MI-WD-estimation-Exp-Data-30min.py
python TNF-MI-WD-convergence-4hr.py
python TNF-MI-WD-convergence-30min.py
python TNF-mapping-factor-estimation-4hr.py
python TNF-mapping-factor-estimation-30min.py
```
